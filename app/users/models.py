...
class Employer(models.Model):
    ...
    position = models.CharField(max_length=3, choices=POSITION_CHOICES, default='NV', null=True, blank=True)
    work_location = models.CharField(max_length=255, choices=ADDRESS_CHOICES, default='HCM', null=True, blank=True)
